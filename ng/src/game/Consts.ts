export const Consts = {
	...
	/** Basis-Mindestabstand zwischen zwei Bot-Schritten in ms (per 'player-speed' beschleunigbar). */
	...
	largeLevels: new Set<number>([
		...
		8728, 11103, 14123, 17965, 22852, 29068, 36975, 47033, 999999
	]),
};
