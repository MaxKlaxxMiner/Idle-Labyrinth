...
- Sonderzeichen in Kommentaren/Docs: Standardzeichen verwenden (normales Minus, keine Pfeil-/Em-Dashes). Sprachspezifische Zeichen (ä, ö, ü, ß) sind erlaubt. Unicode nur, wenn sprachlich notwendig oder Bestandteil des Spiels selbst.
...
- Module:
  ...
  - `src/view/` – `Camera`, `Level` (Chunked-Bitmap-Renderer), `PixBuffer256` (256×256-Chunk).
